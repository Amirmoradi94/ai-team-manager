...
[CTO] AI Decision Models available: gemini-3-pro, claude-opus-4.5, claude-sonnet-4.5, gemini-3-pro
📡 Polling for tasks...
✅ Runner is active
```
...
AI Engine: ✓
Use AI: true
Models: gemini-3-pro, claude-opus-4.5, claude-sonnet-4.5, gemini-3-pro
```
